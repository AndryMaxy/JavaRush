...
public class Solution {
    public static final String UNIC_BINDING_NAME = "test.remote";
    public static final String UNICC_BINDING_NAME = "tests.remote";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                Cat cat = new Cat("pidr");
                Dog dog = new Dog("syka");
                ...
                registry.bind(UNICC_BINDING_NAME, stub2);
                Thread.sleep(1000);
